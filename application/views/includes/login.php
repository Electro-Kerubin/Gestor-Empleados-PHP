...
<head>
    ...
    <link href="<?php echo base_url() . 'application/assets/css/style-responsive.css' ?>" rel="stylesheet">
...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url() . 'application/assets/js/jquery.backstretch.min.js' ?>"></script>
    <script>
